...
//    val graph = WarehouseGraphBuilder(warehouseRepo.getAll(),routeRepo.getAll()).build().adjacencyMap
//
...
//    Logger.info("=========================================================")
    ...
    warehouseRepo.getAll().forEach { warehouse -> println("[${warehouse.id}] - Cargo Size -> ${warehouse.cargoQueue.size}") }
//    Logger.info("\n================ALL PAIRS SHORTEST PATHS==================")
//
//
//    Logger.info("origin".padEnd(12) +
...
//            append(origin.id.padEnd(12))
//            selectionWarehouses.forEach { destination ->
//                val distance = graph[origin]?.get(destination)
//
//                append(
//                    String.format("%12.2f", distance)
//                )
